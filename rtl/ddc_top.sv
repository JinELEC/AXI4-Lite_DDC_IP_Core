module ddc_top(
    ...
    output logic signed [15:0] x_o, // 16, 32, 64-bit
...
logic signed [15:0] wire_x_in; // 16, 32, 64-bit
logic signed [15:0] wire_y_in; // 16, 32, 64-bit
assign wire_x_in = { {8{wire_x[7]}}, wire_x }; 
assign wire_y_in = { {8{wire_y[7]}}, wire_y };
