...
**Aliased image frequency = 5 MHz - 3.1333 MHz ≈ 1.868 MHz**

The 200 kHz component is the desired down-converted signal, while the
1.868 MHz component is suppressed by the FIR low-pass filter.
...
The 0.2 MHz component indicates the desired down-converted signal, while the 1.868 MHz component represents an unwanted frequency component. Increasing the number of FIR taps improves the attenuation of unwanted components.
